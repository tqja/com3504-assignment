...
function openSyncObservationsIDB() {
    return new Promise((resolve, reject) => {
        const request = indexedDB.open("sync-observations", 1);
...
const addNewSyncObservation = (IDB, observation) => {
    return new Promise((resolve, reject) => {
        const transaction = IDB.transaction(["sync-observations"], "readwrite");
        const observationStore = transaction.objectStore("sync-observations");
...
const getSyncObservation = (IDB, observationID) => {
    return new Promise((resolve, reject) => {
        const transaction = IDB.transaction(["sync-observations"]);
        const observationStore = transaction.objectStore("sync-observations");
        const request = observationStore.get(observationID);
...
const getAllSyncObservations = (IDB) => {
    return new Promise((resolve, reject) => {
        const transaction = IDB.transaction(["sync-observations"]);
        const observationStore = transaction.objectStore("sync-observations");
        const request = observationStore.getAll();
...
const updateSyncObservation = (IDB, observation) => {
    return new Promise((resolve, reject) => {
        const transaction = IDB.transaction(["sync-observations"], "readwrite")
        const observationStore = transaction.objectStore("sync-observations")
...
const deleteSyncObservation = (IDB, observationID) => {
    const transaction = IDB.transaction(["sync-observations"], "readwrite")
    const observationStore = transaction.objectStore("sync-observations")
    const request = observationStore.delete(observationID)
